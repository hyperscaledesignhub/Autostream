...
output "demo_image_repository" {
  description = "ECR repository URL for demo image"
  value       = var.demo_image_repository != "" ? var.demo_image_repository : aws_ecr_repository.demo_app.repository_url
}

output "fluss_image_repository" {
  description = "ECR repository URL for Fluss image"
  value       = var.use_ecr_for_fluss ? (var.fluss_image_repository != "" ? var.fluss_image_repository : aws_ecr_repository.fluss.repository_url) : "Using Docker Hub: apache/fluss"
}
